...
public class Separateur {
    ...
    public Separateur(String monLibelle) {
        libelle = "";
        setLibelle(monLibelle);
    }
    ...
    public void setLibelle(String libelle) {
        ...
        if (libelle.equals("")) this.libelle = " ";
        if (valeursAutorisees.contains(libelle)) this.libelle = libelle;
        else System.err.println("Séparateur d'accords '" + libelle + "' non reconnu.");
    }

    // Cette fonction permet d'extraire tous les séparateurs dans une chaîne
    // de type : "Am\tC/F G\n" renvoie les séparateurs " ", "/", " ", "\n" dans
    // une arrayList
    public static String getListeSeparateurs(String chaineAccord, List<Separateur> listeSeparateurs) {
